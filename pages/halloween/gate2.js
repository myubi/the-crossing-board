...
export default class Gate2 extends React.Component {
  ...
  handleSubmit(event) {
    ...
    const currentSet = this.props.halloweenSets[1];
    ...
    if(this.state.code1 === currentSet.hints[0].answer &&
      this.state.code2 === currentSet.hints[1].answer &&
      this.state.code3 === currentSet.hints[2].answer &&
      this.state.code4 === currentSet.hints[3].answer
      )
    {
      this.setState({
        unlock: true
      ...
      if(this.state.code2 !== currentSet.hints[1].answer){
        document.getElementById('warning-code2').classList.remove("hidden");
      }
      if(this.state.code3 !== currentSet.hints[2].answer){
        document.getElementById('warning-code3').classList.remove("hidden");
      }
      if(this.state.code4 !== currentSet.hints[3].answer){
        document.getElementById('warning-code4').classList.remove("hidden");
      }
    }
  }
    ...
    return (
      ...
      {this.state.unlock &&
        ...
        <h1>Congratulations!</h1>
          <p>You have unlocked a Halloween Color Me Up Image!!</p>
          <p>Click on the image to download</p>
          <p>DM us a screenshot of this page on either Twitter or Instagram, and if you are the first you will receive 10 of each color of pumpkin in Animal Crossing New Horizons!</p>
