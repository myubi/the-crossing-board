...
export default class Gate1 extends React.Component {
  ...
  handleSubmit(event) {
    ...
    const currentSet = this.props.halloweenSets[0];
    ...
    if(this.state.code1 === currentSet.hints[0].answer &&
      ...
      this.state.code5 === currentSet.hints[4].answer
      )
    {
      this.setState({
        unlock: true
      ...
      if(this.state.code5 !== currentSet.hints[4].answer){
        document.getElementById('warning-code5').classList.remove("hidden");
      }
    }
  }
          ...
          {currentSet.hints.map((hint, index) => 
              (
                <div className="hint-wrapper">
                  <div><img className="candy" src={`../halloween/candy${index + 1}.png`} alt="" /></div>
