...
export default class QuizContainer extends React.Component {
  ...
  componentDidMount() {
  const shuffledAnswerOptions = this.props.questions.map((question) => this.shuffleArray(question.answers));  
  ...
  renderResult() {
  	return (
      <div>
  		<Result quizResult={this.state.result} quizResultText={this.props.results[this.state.result]} />
  ...
  render() {
    return (
      ...
      <div className="quiz-name">{this.props.name}
      </div>
